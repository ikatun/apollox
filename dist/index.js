...
function createGraphqlClient(client, defaultApiErrorHandler) {
    var _this = this;
    var mutation = function (graphqlMutation) {
        return function (variables, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var alertErrors, apolloOptions, response, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            alertErrors = options.alertErrors, apolloOptions = __rest(options, ["alertErrors"]);
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, client.mutate(__assign({ variables: variables, mutation: graphqlMutation }, apolloOptions))];
                        case 2:
                            response = _a.sent();
    ...
    var query = function (graphqlQuery) {
        function createQuery(variables, options) {
            ...
            mobx_1.extendObservable(result, {
        ...
        return fast_memoize_1.default(createQuery);
    };
